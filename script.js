...
function MyFunction01() {
    ...
    obj.style.backgroundColor = 'rgb(247,160,160)';
  }

// ID要素の背景色を変える
function MyFunction02(){
    var obj = document.getElementById('ID01');
    obj.style.backgroundColor = 'rgb(252,252,155)';
  }
...
function MyFunction03(){
  ...
  for( var i=0; i<lines.length; i++ ){
        lines[i].style.backgroundColor = 'rgb(156,251,180)';
  }
}
...
function MyFunction04() {
  ...
  for( var i=0; i<obj.length; i++ ) { 
      ...
      obj[ i ].style.backgroundColor = "rgb(135,157,221)"; 
  }
}
